...
namespace Registry.Other
{
    ...
    public static class Helpers
    {
        ...
        public enum SidTypeEnum
        {
            ...
            [Description("S-1-5-1: A group that includes all users who have logged on through a dial-up connection.")] Dialup,
            [Description("S-1-5-2: A group that includes all users who have logged on through a network connection.")] Network,
            [Description("S-1-5-3: A group that includes all users who have logged on through a batch queue facility.")] Batch,
            ...
            [Description("S-1-5-6: A group that includes all security principals that have logged on as a service.")] Service,
            ...
            [Description("S-1-5-13: A group that includes all users who have logged on to a Terminal Services server.")] TerminalServerUser,
            ...
            [Description("S-1-5-1000: A group that includes all users and computers from another organization. ")] OtherOrganization,
            [Description("S-1-5-17: An account that is used by the default Internet Information Services (IIS) user.")] Iusr,
            ...
            [Description("S-1-5-21-<domain>-513: A global group that includes all user accounts in a domain.")] DomainUsers,
            ...
            [Description("S-1-5-21-<domain>-516: A global group that includes all domain controllers in the domain.")] DomainDomainControllers,
            ...
            [Description("S-1-5-21-<domain>-521: A global group that includes all read-only domain controllers.")] ReadonlyDomainControllers,
            ...
            [Description("S-1-5-32-555: An alias. Members of this group are granted the right to log on remotely.")] RemoteDesktop,
            ...
            [Description("S-1-5-32-558: An alias. Members of this group have remote access to monitor this computer.")] PerfmonUsers,
            ...
            [Description("S-1-5-32-561: An alias. A group for Terminal Server License Servers.")] TerminalServerLicenseServers,
            ...
            [Description("S-1-5-32-575: A group that allows members use of Remote Application Services resources.")] RdsRemoteAccessServers,
            ...
            [Description("S-1-5-32-578: A group that gives members access to all administrative features of Hyper-V.")] HyperVAdmins,
        ...
        public static bool ExportToReg(string filename, RegistryKey key, HiveTypeEnum hiveType, bool recursive)
        {
            ...
            sb.AppendLine(string.Format(";Generated on {0}", DateTimeOffset.UtcNow));
            sb.AppendLine();
